...
[Bitcoin Core version 0.11.0](https://bitcoin.org/bin/bitcoin-core-0.11.0/)
  ...
  * recommendations
    ...
    * | 
      * Windows,
        * run the installer
      * Mac,
        * copy -- over -- /Applications/Bitcoin-Qt
      * Linux,
        * bitcoind/bitcoin-qt 
...
* TODO: Because release 0.10.0 and later makes use of headers-first synchronization and
...
other programs
* Reindexing using earlier versions will also not work
...
directory
* Without this your node will need start syncing (or importing from
bootstrap.dat) anew afterwards
* It is possible that the data from a completely
...
* | big-endian CPU architectures,
  * experimental support
    * test | 
      * MIPS hosts
      * PPC hosts 
* little-endian specific code -- was replaced with -- endian-neutral constructs

* build system will AUTOMATICALLY detect the target's endianness 
